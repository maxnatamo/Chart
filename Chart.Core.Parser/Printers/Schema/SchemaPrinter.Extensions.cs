namespace Chart.Core.Parser
{
    public partial class SchemaPrinter
    {
        ...
        {
            this.context.WriteLine($"extend scalar ");
        ...
        {
            this.context.WriteLine($"extend type ");
        ...
        {
            this.context.WriteLine($"extend interface ");
        ...
        {
            this.context.WriteLine($"extend union ");
        ...
        {
            this.context.WriteLine($"extend enum ");
        ...
        {
            this.context.WriteLine($"extend input ");
