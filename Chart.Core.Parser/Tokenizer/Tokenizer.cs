...
namespace Chart.Core.Parser
{
    public class Tokenizer
    {
        ...
        /// </summary>
        private static char[] PUNCTUATION_TOKENS =
        {
            ':',
            '[',
            ']',
        ...
        /// </summary>
        private static char[] WHITESPACE_TOKENS =
        {
            '\r',
            '\t',
            '\n',
        ...
        private Token ReadToken()
        {
            ...
            return new Token(TokenType.UNKNOWN, this.CurrentIndex, this.CurrentIndex + 1);
        }
        ...
        private Token ParsePunctuationToken() => this.Source[this.CurrentIndex] switch
        {
        ...
        private string GetUntil(Func<string, bool> predicate, int windowSize = 3)
        {
            ...
            return this.Source.Substring(this.CurrentIndex, idx - this.CurrentIndex);
        }
        ...
        private bool ContainsNext(string next, bool matchWhole = true)
        {
            ...
            if(matchWhole)
            {
                if(this.CurrentIndex + next.Length < this.Source.Length)
                {
                    ...
                    if(!WHITESPACE_TOKENS.Contains(charAfterString))
                    {
                        return false;
                    }
                }
