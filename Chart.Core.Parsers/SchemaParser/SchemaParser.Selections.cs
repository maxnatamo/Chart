...
namespace Chart.Core.Parsers
{
    public partial class SchemaParser
    {
        ...
        {
            GraphSelectionSet def = new GraphSelectionSet();
            ...
            {
                throw new EmptySelectionException(this.CurrentToken.Start);
            }
        ...
        {
            GraphFieldSelection def = new GraphFieldSelection();

            var firstName = this.CurrentToken.Value;
            this.Skip();
